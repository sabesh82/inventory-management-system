...
interface ITextArea extends ComponentProps<typeof AriaTextArea> {
    ...
    return (
      ...
      >
        ...
        {Label && (
          <AriaLabel
            className={cn(
              "flex w-max items-center justify-start gap-1 text-sm font-medium transition-colors duration-150",
              { "text-red-700": error },
              labelClass,
              { "mb-1.5": !description }
            )}
        ...
        {/* TextArea with error animation and Icon */}
        <motion.div
          animate={errorAnimationControls}
          variants={{
            vibrate: {
